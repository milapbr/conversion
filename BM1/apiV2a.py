...
p.add_argument('data_through', help="The end day that the data is reflective of.")
p.add_argument('data_month', help="The end month that the data is reflective of.")
p.add_argument('data_year', help="The end year that the data is reflective of.")
...
post_data = {
                ...
                'data_through' : args.data_through, #mid month update
