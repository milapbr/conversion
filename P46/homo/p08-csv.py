...
even='csv-07-2018 july even numbers_out.csv' #ok
even='work-csf-08-2018 August even report.csv'
def px(name):
    """
...
def load(df):
    ...
    for i in df.iterrows():
        ...
        print 'sales = ', (i[1]["sales"])
        print 'rec_cost = ', (i[1]["rec_cost"])
        print 'rec_retail = ', (i[1]["rec_retail"])
        print 'venret = ', (i[1]["venret"])
        print 'coo = ', (i[1]["coo"])
        print 'roo = ', (i[1]["roo"])
        #output[key]["mup"]       += float(i[1]["mup"])
        print 'mdown = ', (i[1]["mdown"])
        #output[key]["inv"]      += float(i[1]["inv"])
        '''

        
        '''
        print 'sales = ', str(i[1]["sales"])
        x=i[1]["sales"]
        '''
        '''
        print 'mdown = ', str(i[1]["mdown"])
        x=i[1]["mdown"]
        print 'x=',x
        x=str(x).replace(',','')
        print 'x=',x
